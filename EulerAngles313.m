...
Outputs: attitude313 - 3 x 1 vector with the 3-1-3 Euler angles
            in the form attitude313 = [𝛼, 𝛽, 𝛾]T
%}
R13 = DCM(1,3);% 1,3 element of the DCM
R23 = DCM(2,3);% 2,3 element of the DCM
R31 = DCM(3,1);% 3,1 element of the DCM
R32 = DCM(3,2);% 3,2 element of the DCM
R33 = DCM(3,3);% 3,3 element of the DCM
alpha = atan2(R13,R23); % numerator = Y , denominator = X , P = atan2(Y,X)
beta = acos(R33);
gamma = atan2(R31,-1*R32);% numerator = Y , denominator = X , P = atan2(Y,X)

attitude313 = [alpha,beta,gamma]'; % 3x1 vector of euler angles [radians]
